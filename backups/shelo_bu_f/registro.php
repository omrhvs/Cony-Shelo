    ...
    <div id="registro-container" class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-sm-9">
                <br>
                <div class="mb-6 row">
                    <label for="inputNombre" class="col-sm-7 col-form-label">Nombre</label>
                    <div class="col-sm-5">
                ...
                <br>
                <div class="mb-6 row">
                    <label for="inputConfirmarEmail" class="col-sm-7 col-form-label">Confirmar Correo</label>
                    <div class="col-sm-5">
                ...
                <br>
                <div class="mb-6 row">
                    <label for="inputConfirmarPassword" class="col-sm-7 col-form-label">Confirmar Contraseña</label>
                    <div class="col-sm-5">
                ...
                <br>
                <div class="mb-6 row">
                    <label for="inputTipoCuenta" class="col-sm-7 col-form-label">Tipo de Cuenta</label>
                    <div class="col-sm-5">
